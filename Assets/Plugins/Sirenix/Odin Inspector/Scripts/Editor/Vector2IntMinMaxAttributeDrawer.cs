...
namespace Sirenix.OdinInspector.Editor.Drawers
{
    ...
    public class Vector2IntMinMaxAttributeDrawer : OdinAttributeDrawer<MinMaxSliderAttribute, Vector2Int>
    {
        ...
        protected override void Initialize()
        {
            ...
            this.minGetter = ValueResolver.Get<float>(this.Property, this.Attribute.MinMember, this.Attribute.MinValue);
            this.maxGetter = ValueResolver.Get<float>(this.Property, this.Attribute.MaxMember, this.Attribute.MaxValue);

            // Min max member reference.
            if (this.Attribute.MinMaxMember != null)
            {
                this.vector2IntMinMaxGetter = ValueResolver.Get<Vector2Int>(this.Property, this.Attribute.MinMaxMember);
            }
        }
